...
def parse_args():
    ...
    parser.add_argument("--data_list", type=str, default="/home/wanghesong/Datasets/mscoco_val2014_30k/subdata_all.csv")   
    parser.add_argument("--img_dir", type=str, default="./outputs/ddp-gen/im256")  
